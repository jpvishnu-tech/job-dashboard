...
function activateTab(tab) {
  ...
  authSub.textContent     = isSignin ? 'Sign in to your account to continue' : 'Start your job search journey today';
  clearBanner();
}
...
function wireEye(eyeBtn, input) {
  eyeBtn.addEventListener('click', () => {
    ...
    eyeBtn.querySelector('.material-icons').textContent = show ? 'visibility_off' : 'visibility';
  });
}
...
formSignin.addEventListener('submit', async e => {
  ...
  if (PLACEHOLDER) {
    showBanner('Firebase is not configured yet. Edit firebase-config.js with your project credentials.', 'warn');
    return;
  }
